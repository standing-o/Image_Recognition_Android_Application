# Image_Recognition_Android_Application (20200706 ~)
...
|Developer|Individual Role|
|---|------|
|정명지|Data collection for application - flower dataset (name, scientific name, flower language) ___ [[In-app dataset]](https://github.com/OH-Seoyoung/Image_Recognition_Android_Application/tree/master/In-app_Data)|
